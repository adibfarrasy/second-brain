...
- reduced employee benefit (no more increments every review period) and very limited career growth opportunity (strict quota on how many can get promotions and the weird "I'm sorry but ", even though many of us deserve it)
# pull factors
- I'll be working on a greenfield project in the new company, building it from the ground up and have more freedom on the design and implementation of the project
- 